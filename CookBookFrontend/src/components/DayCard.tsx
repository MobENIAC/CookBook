...
export const DayCard: FC<DayCardProps> = ({
  ...
  const handleChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    const selectedRecipe = recipesFromApi.find(
  ...
  return (
    <>
      <section className="dayCard">
        ...
        <h3 className="dayCard__dayTitle">{dayName}</h3>
        ...
        <div className="dayCard__filter">
          <div className="filter__main">
            <Form className="dayCard__form">
              ...
              >
                <option className="filter__options" value="">
                  All Recipes
                </option>
      ...
      {showViewModal && showRecipeData !== null && (
        <RecipeViewModal
