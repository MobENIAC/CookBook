            ...
            <section className="profiles">
                <div className="profiles__card">
                    ...
                    <div className="card__text">
                        ...
                        <p className="card__description">I’m a Pakistani living in Stockholm with a passion for coding and new technologies. Looking for an opportunity that will challenge my coding and problem-solving skills. I am detail-oriented and self-driven with deep understanding, knowledge & skills of developing & implementing web-based solutions, maintaining & updating web applications.</p>
                    </div>
                </div>
                <div className="profiles__card">
                    ...
                    <div className="card__text">
                        ...
                        <p className="card__description">I am a Greek living in Stockholm eager about web development & AI. As an engineer and inventor, I am always open to learning new technologies and applying them in practice. Natural leader who acts as a force multiplier in the team. Previously worked as industrial data scientist and plant director.</p>
                    </div>
                </div>
                <div className="profiles__card">
